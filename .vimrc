"Last Modified: 2019-12-20 10:31:07
...
if has("gui_running")
    ...
    if MySys() == "Windows"
        ...
        ""FullScreen
        "<F11> Enable Disable
        map <F11> <Esc>:call libcallnr("gvimfullscreen.dll", "ToggleFullScreen", 0)<CR>v<ESC>
        imap <F11> <C-O>:call libcallnr("gvimfullscreen.dll", "ToggleFullScreen", 0)<CR>v<ESC>
    endif
endif

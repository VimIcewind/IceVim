"Last Modified: 2018-01-30 09:09:06
...
"文件默认换行符为unix的\n即<LF>
set fileformat=unix
"如果Linux系统编码包含GB(GBK,gbk,GB18030,gb18030), 则Vim内部编码cp936, 文件编码默认cp936
...
if has("gui_running")
    ...
    if MySys() == "Windows"
        ...
        ""FullScreen
        "<F11> Enable Disable
        map <F11> <Esc>:windo set nu!<CR>:call libcallnr("gvimfullscreen.dll", "ToggleFullScreen", 0)<CR>v<ESC>
        imap <F11> <C-O>:call libcallnr("gvimfullscreen.dll", "ToggleFullScreen", 0)<CR><C-O>:windo set nu!<CR>
    endif
endif
